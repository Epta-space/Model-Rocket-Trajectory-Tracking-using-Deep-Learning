%%Parâmetros do controlador (já calculados e otimizados):[4.9878 0 4.9878]
%FUNÇÃO QUE FAZ O CONTROLADO NEURO-FUZZY
%FUNÇÃO QUE CALCULA A AÇÃO DE CONTROLE 
%CONTROLE LONGITUDINAL

function output=control_NF_theta(erro_theta,delta_prof_k,prop_SBRF2)
...
%POSIÇÃO DO PROFUNDOR NO TEMPO K+1 (DELTA_PROF_K1)
...
for i=1:rules
    aux=aux+1;
    plano=prop_SBRF2(aux,:); %prop é a matriz de alfa que vem do método de otimização
    u4(i)=u3(i)*plano(1);
