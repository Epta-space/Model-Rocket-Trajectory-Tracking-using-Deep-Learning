...
nT_max = 50; %Numero de ciclos de resfriamento / ~nmaxgeracoes
nX_max = 5; %Numero de iterações para cada T / ~nind
sigma = 0.1; % Desvio padrão da distribuição normal
m = 2; %Numero de elementos do vetor X / ~nvar
...
for i=1:m
   var(i)=(lsup(i)-linf(i))*X(i)+linf(i);
